...
def main(rank=local_rank):
    ...
    if rank == 0:
        ...
        id_clr = get_data(params=params, train=False, category="id", trn="simclr", formatter="id")
        loader_id_clr = get_dataloader(params, id_clr, drop_last=False, shuffle=False)

        ood_clr = get_data(params=params, train=False, category="ood", trn="simclr", formatter="id")
